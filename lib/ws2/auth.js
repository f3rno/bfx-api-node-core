 ...
 * @return {Promise} p - resolves on successful auth with socket state
 */
const authWS = async (state = {}, { dms = 0, calc = 0 } = {}) => {
...
module.exports = { ws: authWS } // exported on object so it can be stubbed
